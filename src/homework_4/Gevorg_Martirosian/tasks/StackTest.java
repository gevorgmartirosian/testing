...
public class StackTest {
    public static void main(String[] args) {
        ...
        DynStack myDynamicStack = new DynStack();
        ...
        for (int i = 0; i < myDynamicStack.getStackArray().length; i++) {
            System.out.print(myDynamicStack.getStackArray()[i] + " ");
        }
        System.out.println();
        ...
        StatStack myStaticStack = new StatStack(5);
        //pushing elements in stack
        System.out.println("step 1");
        for (int i = 1; i <= 5; i++) {
        ...
        //printing stack after step 1
        for (int i = 0; i < myStaticStack.getStackArray().length; i++) {
            System.out.print(myStaticStack.getStackArray()[i] + " ");
        }
        System.out.println();
